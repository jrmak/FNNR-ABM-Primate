...
def save_summary_humans(steps, number_of_humans, human_birth_count, human_death_count, num_labor,
                 single_male_count, married_male_count, gtgp_part_percentage, total_migration,
                        total_re_migration):
    ...
    if steps == 0:
        ...
        filewriter.writerow(
            ['Steps', 'Total Humans', 'Births', 'Deaths', 'Laborers', 'Single Males', 'Married Males',
             'GTGP Part. %'
             ])
    ...
    fnnr_export.writelines(',')
    fnnr_export.writelines(str(gtgp_part_percentage))
    fnnr_export.writelines(',')
    fnnr_export.writelines(str(total_migration))
    fnnr_export.writelines(',')
    fnnr_export.writelines(str(total_re_migration))
    fnnr_export.writelines(',')
