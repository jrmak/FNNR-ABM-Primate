...
if __name__ == '__main__':
    ...
    forest_label = tk.Label(root, text="Forest Area:")
    ...
    run_count = tk.Label(root, )
    run_count.grid(row=24, column=0, padx=10)
