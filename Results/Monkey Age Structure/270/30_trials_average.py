...
It will take each of the 30 trials' outputs and average them.
The number of trials can be adjusted; the default is 30 ('counter < 31').
"""

set_file_name = 'average_30.csv'
...
def get_values():
    for i in list(range(2, 245)):
        for filename in os.listdir(os.getcwd()):
            if filename[-3:] == 'csv' and str(filename) != str(set_file_name) and str(filename) != 'steps.csv':
