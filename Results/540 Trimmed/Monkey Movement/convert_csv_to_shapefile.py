...
name_of_shp = 'shapefile_540' # change your shapefile name here

currentpath = os.getcwd()
file_name = currentpath + '\\abm_export_density_plot_with_humans_1.csv'

file_name_new = currentpath + '\\abm_export_density_plot_with_humans_1_copy.csv'
