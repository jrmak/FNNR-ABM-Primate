...
name_of_shp = 'difference_270-540_20_percentage' # change your shapefile name here

currentpath = os.getcwd()
file_name = currentpath + '\\difference270-540_20_percentage.csv'

file_name_new = currentpath + '\\difference270-540_20_percentage_copy.csv'
