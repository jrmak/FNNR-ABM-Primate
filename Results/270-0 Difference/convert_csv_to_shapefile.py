...
name_of_shp = 'difference_270-0_10' # change your shapefile name here

currentpath = os.getcwd()
file_name = currentpath + '\\difference270-0_10.csv'

file_name_new = currentpath + '\\difference270-0_10_copy.csv'
