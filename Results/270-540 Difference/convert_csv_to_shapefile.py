...
name_of_shp = 'difference_270-540_20' # change your shapefile name here

currentpath = os.getcwd()
file_name = currentpath + '\\difference270-540_20.csv'

file_name_new = currentpath + '\\difference270-540_20_copy.csv'
