...
name_of_shp = 'shapefile_difference_540_10' # change your shapefile name here

currentpath = os.getcwd()
file_name = currentpath + '\\difference_270_540-10.csv'

file_name_new = currentpath + '\\difference_270_540_10_copy.csv'
