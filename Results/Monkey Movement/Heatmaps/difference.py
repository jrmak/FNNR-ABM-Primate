...
"""
directory_path = 'C:\\Users\\Judy\Desktop\\FNNR-ABM-Primate-master\\Results\\Monkey Movement\\Heatmaps'

text1 = directory_path + '\\abm_export_density_plot_with_humans_61_10.csv'
text2 = directory_path + '\\abm_export_density_plot_with_humans_31_10.csv'
...
try:
    diff = open('difference_270_540-10.csv', 'w+')  # a+ will create the file if it doesn't exist already
except IOError:
